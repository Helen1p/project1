# modified from: /root/miniconda3/envs/ssa/lib/python3.8/site-packages/mmdet/core/visualization/image.py
...
from mmdet.models.utils.misc import mask2ndarray
from mmdet.visualization.palette import get_palette, palette_val
    ...
    if segms is not None:
        ...
        if num_bboxes < segms.shape[0]:
            ...
            for mask in segms:
                ...
                # borrow from: /GPT-4V-AD-main/region_division.py
                # 并没有centered，因为存在一块mask有两块sub-mask的情况
                ...
                # positions.append(np.array([xc,yc]))
